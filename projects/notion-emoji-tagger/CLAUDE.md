# CLAUDE.md — notion-emoji-tagger

Guidance for Claude Code when working on **this project**. This is one project
inside the Claude-Cloud sandbox monorepo; the sandbox-wide conventions (project
layout, shared tooling, keys) live in the repo-root [`../../CLAUDE.md`](../../CLAUDE.md).
When working here, treat this folder (`projects/notion-emoji-tagger/`) as the
working root.
